...
namespace PiAlarm::hardware {
    ...
    public:
         ...
         *
         * @param dcLineConfig Configuration of the dcLine (data/command) GPIO pin.
         * @param resetLineConfig Configuration of the reset GPIO pin.
         * @param spiLineConfig Configuration of the SPI line.
         ...
         */
        SSD1322(const GPIOConfig& dcLineConfig,
                const GPIOConfig& resetLineConfig,
                const SPIConfig& spiLineConfig = SPIConfig{}
        );
